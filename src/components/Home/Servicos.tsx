...
export default function Servicos() {
  ...
  return (
    <div className="h-screen px-32 w-full pt-[10rem] flex flex-col items-center gap-3">
      <h1 className="uppercase text-4xl font-title">Serviços</h1>
      <div className="grid grid-cols-2 grid-rows-3 h-2/3 w-4/5">
        <div className="overflow-hidden flex row-span-3 items-center justify-center cursor-pointer" onClick={() => history("/mentoria")}>
          <div className="bg-bgMentoria w-full h-full hover:scale-105 transition-all flex items-center justify-center bg-center bg-cover">
            <h1 className="text-4xl text-white uppercase tracking-wider">Mentoria</h1>
          </div>
        </div>
